...
export const ru = {
  ...
  lobby: {
    ...
    host: 'хост',
    offline: 'не на связи',
    fillBots: 'Добить ботами',
    start: 'Старт ▶',
    waiting: 'Ждём, пока хост начнёт',
    leave: 'Выйти',
    toLobby: 'В комнату',
    reconnecting: 'Переподключаемся…',
    lost: 'Связь потеряна',
    replaced: 'Вы вошли с другого устройства',
    errors: {
      no_room: 'Комнаты с таким кодом нет',
      room_full: 'Комната заполнена',
      not_host: 'Это может только хост',
      already_playing: 'Партия уже идёт',
      not_in_room: 'Вы не в комнате',
      too_few_players: 'Нужно хотя бы двое',
      not_enough_cards: 'На такую раздачу не хватит карт',
      bad_auth: 'Не удалось войти',
      bad_message: 'Сервер не понял запрос',
      replaced: 'Вы вошли с другого устройства',
  ...
  act: {
    drew: 'вытянул',
    drewTrump: (suit: string) => `вытянул козырь — ${suit}`,
    kept: 'оставил себе',
    played: 'побил',
